...
exports.sendMail = async function ({ to, subject, html }) {
  ...
  // console.log(to, subject, "sendEmail")
...
exports.invoiceTemplate = function ({orders}) {
  // console.log(orders[0].id, "invoice template")
  const totalAmount = orders.reduce((amount, item)=>item.totalAmount + amount, 0)
          ...
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="https://sendgrid.com" target="_blank" style="display: inline-block;">
                <img src="https://img.freepik.com/premium-vector/anime-logo-mascot-vector_671539-45.jpg" alt="Logo" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
              </a>
            </td>
          </tr>
        </table>
            ...
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              ...
              ${orders.map((item, index)=>
                `<tr>
                  ...
                  <td align="left" bgcolor="#D2C7BA" width="25%" style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><strong>${item.id}</strong></td>
                </tr>
                <tr>
                  <td align="left" width="75%" style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">${item.item.title}</td>
                  <td align="left" width="25%" style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">$${item.totalAmount} (${item.quantity})</td>
                </tr>`
              )}
                <tr>
                ...
                <tr>
                  ...
                  <td align="left" width="25%" style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">${orders[0].paymentMethod === "cash"? "Cash On Delivery" : "Prepaid"}</td>
                </tr>
                <tr>
                  ...
                  <td align="left" width="25%" style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-top: 2px dashed #D2C7BA; border-bottom: 2px dashed #D2C7BA;"><strong>$${totalAmount}</strong></td>
                </tr>
              </table>
            </td>
          </tr>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                  <tr>
                    <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                      ...
                      <p>${address.street}<br>${address.city}<br>${address.state}, ${address.postalCode}</p>
                    </td>
                  </tr>
                </table>
              </div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                  <tr>
                    <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                      ...
                      <p>${address.street}<br>${address.city}<br>${address.telephone}<br>${address.state}, ${address.postalCode}</p>
                    </td>
                  </tr>
                </table>
              </div>
